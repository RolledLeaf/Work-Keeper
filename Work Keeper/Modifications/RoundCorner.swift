...
enum DeviceLayout {
    ...
    static func cardRadiusForFraction(for width: CGFloat) -> CGFloat {
        switch width {
        case 440: //iPhone 16 Pro Max / 17 Pro Max
            return 0.7
        case 402:
            return 0.75
        case 375:  //iPhone 13 mini / 12 mini / 11 Pro / XS / X
            return 0.8
        case 393:
            return 0.75
        case 428:
    ...
    //  чек  iPhone 16 Pro Max / 17 Pro Max: 440 x 956 pt
    //  чек  iPhone 16 Pro / 17 Pro: 402 x 874 pt
    //  чек  iPhone 16 / 15 / 14 Pro: 393 x 852 pt
    //  чек  iPhone 16 Plus / 15 Pro Max / 15 Plus / 14 Pro Max: 430 x 932 pt
    //   чек iPhone 14 Plus / 13 Pro Max / 12 Pro Max: 428 x 926 pt
    //   чек iPhone 14 / 13 Pro / 13 / 12 Pro / 12: 390 x 844 pt
    
    //    Older & Compact Models
    //  чек  iPhone 13 mini / 12 mini / 11 Pro / XS / X: 375 x 812 pt
    //   чек iPhone 11 / 11 Pro Max / XS Max / XR: 414 x 896 pt
