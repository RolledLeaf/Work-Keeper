                ...
                ForEach(addresses, id: \.objectID) { address in
                    ...
                    .contextMenu {
                        ...
                        Button(role: .destructive) {
                            ...
                            let count = viewModel.activeTasksCount(for: address)
                            tasksCountForDelete = count
            ...
            .confirmationDialog(
                ...
                Button("Удалить", role: .destructive) {
                    if let addr = addressToDelete {
                        viewModel.softDelete(addr, for: client, in: context, cascade: false)
                        addressToDelete = nil
                    }
                }
...
//            .confirmationDialog(
//                "У адреса есть задания",
//                isPresented: $showCascadeDeleteDialog,
//                titleVisibility: .visible
//            ) {
//                Button("Удалить вместе с заданиями", role: .destructive) {
//                    if let addr = addressToDelete {
//                        viewModel.softDelete(addr, for: client, in: context, cascade: true)
//                        addressToDelete = nil
//                    }
//                }
//
...
//
//            } message: {
//                Text("У этого адреса есть \(tasksCountForDelete) заданий. Удалить адрес вместе со всеми заданиями?")
//            }
        }
    }
}
